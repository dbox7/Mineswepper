...
export function drowSwitches() {
  const switchContainer = createElement('div', 'switch__container');

  const switchTitle1 = createElement('div', 'welcome__diff');
  switchTitle1.innerHTML = 'Theme';
  const swiitchBlock1 = createElement('div', 'switch__block');
  const switchItem1 = createElement('input', 'switch', 'switch__theme');
...
export function drowBoard(dark = 'o') {
  ...
  const mainBoard = createElement('selection', 'main__board', dark);
  ...
  for (let i = 0; i < demension ** 2; i += 1) {
    const cell = createElement('div', 'main__board-cell', dark);
    mainBoard.appendChild(cell);
  }

  const mainButtons = createElement('div', 'main__buttons');
  const mainButton = createElement('button', 'button', 'main__button', dark);
  mainButton.innerHTML = 'New Game';
  const scoreButton = createElement('button', 'button', 'main__score', dark);
